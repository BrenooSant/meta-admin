...
import { useFinanceiroAcademia } from "../../../hooks/financeiro/Usefinanceiroacademia";
import type { SemanaData } from "../../../hooks/financeiro/Usefinanceiroacademia";
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={anual} barSize={28}>
              ...
              <Bar dataKey="faturamento" radius={[5, 5, 0, 0]}>
                {anual.map((_, i) => <Cell key={i} fill={i === anual.length - 1 ? "#1d4ed8" : "#2563eb"} />)}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </div>
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={alunosPorMes} barSize={28}>
              ...
              <Bar dataKey="alunos" radius={[5, 5, 0, 0]}>
                {alunosPorMes.map((_, i) => <Cell key={i} fill={i === alunosPorMes.length - 1 ? "#1d4ed8" : "#2563eb"} />)}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </div>
